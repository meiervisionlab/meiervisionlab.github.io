...
Ordered by training stage. This list is for anyone who finds it helpful, but if you're in the lab tell Dr. Meier if you want to apply for any of them (I do a poor job of keeping track who is eligible for what).
  ...
  * **Postdocs** (US citizens, non-citizen nationals, and permanent residents): [NIH F32](https://researchtraining.nih.gov/programs/fellowships/F32) 
...
### training opportunities
  ...
  * [ERP Boot Camp](https://erpinfo.org/the-erp-boot-camp) for fundamentals of ERP research - virtual training is up from a past session, and keep an eye out for future sessions
  * [FSL Course](https://open.win.ox.ac.uk/pages/fslcourse/website/index.html) for structural, functional and diffusion MRI - self-paced online course, with in-person sessions typically synch'd with OHBM annual meeting
  * Li Zhaoping's [Systems Vision Science Summer School & Symposium](https://summerschool.lizhaoping.org/) - online recordings are up from past sessions, and keep an eye for future sessions
  * Allen Institute's [Summer Workshop on the Dynamic Brain](https://alleninstitute.org/events/summer-workshop-on-the-dynamic-brain-2025/) for graduate students and postdocs for a two-week intensive on the neurobiology of sensory processing, coding, and neural population dynamics

  
### learning to program

Our lab uses MATLAB/Psychtoolbox to present experiments and to process neuroimaging data; and R for statistics. Some labs also use Python/PsychoPy. Learning one programming language does make it easier to learn another programming language, although each has its own quirks that can make it difficult to learn two simultaneously (0-index vs 1-indexing, indentations vs parentheses, etc ..)
...
### great papers
  ...
  * Carandini M & Heeger D (2011) [Normalization as a canonical computation](https://pubmed.ncbi.nlm.nih.gov/22108672/). *Nat Rev Neurosci, 13*, 51-62. "There is increasing evidence that the brain relies on a set of canonical neural
